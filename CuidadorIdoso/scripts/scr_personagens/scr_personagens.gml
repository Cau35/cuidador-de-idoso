...
function Personagem_CuidadorSJ() constructor {

	sprite_idle = spr_phsj_parado_baixo
	sprite_walk = spr_phsj_caminhando_direita
}
...
function Personagem_CuidadorCJ() constructor {
	...
	sprite_idle = spr_phcj_parado_baixo
	sprite_walk = spr_phcj_caminhando_direita
}
